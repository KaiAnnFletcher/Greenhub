...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['../utils/ApiClient', './BrowseNodeInfo', './CustomerReviews', './Images', './ItemInfo', './Offers', './RentalOffers', './VariationAttribute'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../utils/ApiClient'), require('./BrowseNodeInfo'), require('./CustomerReviews'), require('./Images'), require('./ItemInfo'), require('./Offers'), require('./RentalOffers'), require('./VariationAttribute'));
  } else {
