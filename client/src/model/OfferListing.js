...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['../utils/ApiClient', './OfferAvailability', './OfferCondition', './OfferDeliveryInfo', './OfferLoyaltyPoints', './OfferMerchantInfo', './OfferPrice', './OfferProgramEligibility', './OfferPromotion'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../utils/ApiClient'), require('./OfferAvailability'), require('./OfferCondition'), require('./OfferDeliveryInfo'), require('./OfferLoyaltyPoints'), require('./OfferMerchantInfo'), require('./OfferPrice'), require('./OfferProgramEligibility'), require('./OfferPromotion'));
  } else {
