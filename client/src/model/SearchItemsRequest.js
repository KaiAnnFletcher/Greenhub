...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['../utils/ApiClient', './Availability', './Condition', './DeliveryFlag', './MaxPrice', './Merchant', './MinPrice', './MinReviewsRating', './MinSavingPercent', './OfferCount', './PartnerType', './Properties', './SearchItemsResource', './SortBy'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../utils/ApiClient'), require('./Availability'), require('./Condition'), require('./DeliveryFlag'), require('./MaxPrice'), require('./Merchant'), require('./MinPrice'), require('./MinReviewsRating'), require('./MinSavingPercent'), require('./OfferCount'), require('./PartnerType'), require('./Properties'), require('./SearchItemsResource'), require('./SortBy'));
  } else {
