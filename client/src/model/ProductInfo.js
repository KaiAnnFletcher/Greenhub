...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['../utils/ApiClient', './DimensionBasedAttribute', './SingleBooleanValuedAttribute', './SingleIntegerValuedAttribute', './SingleStringValuedAttribute'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../utils/ApiClient'), require('./DimensionBasedAttribute'), require('./SingleBooleanValuedAttribute'), require('./SingleIntegerValuedAttribute'), require('./SingleStringValuedAttribute'));
  } else {
