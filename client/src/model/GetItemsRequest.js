...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['../utils/ApiClient', './Condition', './GetItemsResource', './ItemIdType', './Merchant', './OfferCount', './PartnerType', './Properties'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../utils/ApiClient'), require('./Condition'), require('./GetItemsResource'), require('./ItemIdType'), require('./Merchant'), require('./OfferCount'), require('./PartnerType'), require('./Properties'));
  } else {
